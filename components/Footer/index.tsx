...
export default function Footer() {
  return (
    <section className="rounded-b-none py-16 mt-48 flex flex-col text-customBlue-900 items-center gap-8 relative">
      ...
      <p className=" font-archivo font-light text-variant opacity-60">
        © Learni 2025
      </p>
    </section>
  );
